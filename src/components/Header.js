...
const Header = () => {
    ...
    return (
        <div className=" bg-slate-800 w-full h-14 flex items-center justify-center shadow-2xl text-white font-['Permanent_Marker'] drop-shadow-2xl sticky top-0 z-10">
            
        <div className=" w-full h-full lg:w-[1200px] flex items-center ">
            <h1 className="ml-5 text-4xl cursor-pointer"> Opus </h1>
            ...
            <div className={header_drop_down_class}>
                <div className=" w-full h-full bg-slate-700 flex flex-col items-center gap-5 pt-5 pb-5 max-h-[125px] shadow-2xl">
                    <button className="button_menu ease-in-out duration-300 w-full text-center"> Games </button>
                    <button className="button_menu ease-in-out duration-300 w-full text-center"> Websites </button>
                </div>
            </div>

            <div onClick={() => check_if_show_drop_down_menu()} className={click_check}></div>

            <button className="hidden lg:inline mr-5 button_menu ease-in-out duration-300"> Games </button>
            <button className="hidden lg:inline mr-5 button_menu ease-in-out duration-300"> Websites </button>
        </div>
